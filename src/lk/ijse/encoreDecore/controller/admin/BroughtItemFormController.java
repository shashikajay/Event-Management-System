...
public class BroughtItemFormController implements Initializable {
    ...
    public void btnAddOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isAdded = ItemModel.addBroughtItem(item);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        try {
            String[] split = ItemModel.getBroughtItemId().split("I");
